...
public class HttpArrivalDataProvider extends AbstractHttpDataProvider {
    ...
    protected URL getURL() throws MalformedURLException {
        return new URL ("http://api.translink.ca/rttiapi/v1/stops/" + Integer.toString(stop.getNumber()) + "/estimates?apikey=" + TranslinkToken.TRANSLINK_API_KEY +"&count=6&timeframe=1440");
    }
